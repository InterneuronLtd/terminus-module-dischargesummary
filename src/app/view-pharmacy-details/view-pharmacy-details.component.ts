...
@Component({
  selector: 'app-view-pharmacy-details',
  templateUrl: './view-pharmacy-details.component.html',
  styleUrls: ['./view-pharmacy-details.component.css']
})
export class ViewPharmacyDetailsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.appService.bannerLabel = "For Review By Pharmacy";
