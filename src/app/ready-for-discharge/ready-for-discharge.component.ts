...
@Component({
  selector: 'app-ready-for-discharge',
  templateUrl: './ready-for-discharge.component.html',
  styleUrls: ['./ready-for-discharge.component.css']
})
export class ReadyForDischargeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.appService.bannerLabel = "Ready for Discharge";
